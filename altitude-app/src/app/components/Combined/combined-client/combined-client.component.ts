...
export class CombinedClientComponent {
  ...
  ngOnInit(): void {
    ...
    this.aiContentGenerationService.getData().subscribe((data) => {
      this.formData = data;
      console.log('=== Combined Client - Form Data Received ===');
      console.log('Full formData:', data);
      console.log('topic:', data?.topic);
      console.log('Type (tone):', data?.Type);
      console.log('purpose:', data?.purpose);
      console.log('readers:', data?.readers);
      console.log('wordLimit:', data?.wordLimit);
      console.log('brand:', data?.brand);
      console.log('campaign2:', data?.campaign2);
      console.log('===========================================');
  ...
  aiContentGeneration1(prompt: string, type: string): void {
    if (type === 'blog') {
      ...
      console.log('=== Regenerate Email - Form Data Check ===');
      console.log('formData object:', this.formData);
      console.log('topic:', this.formData?.topic);
      console.log('Type:', this.formData?.Type);
      console.log('purpose:', this.formData?.purpose);
      console.log('readers:', this.formData?.readers);
      console.log('wordLimit:', this.formData?.wordLimit);
      console.log('==========================================');
...
<em>2. Body should have keywords/variation of keywords</em> `;
  ...
  // Initialize Email Payload for regeneration
  initializeEmailPayload(): void {
    ...
    console.log('Email Payload initialized in client with word_limit:', this.formData?.wordLimit);
  }

  // Initialize Social Media Payload for regeneration
  ...
  // Initialize Blog Payload for regeneration
